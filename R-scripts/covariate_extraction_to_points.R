...
cov_path <- "D:/InputData/Environmental_Covariate/Covariates_Aligned"
...
soil_points <- read.csv("D:/InputData/SoilData/data-science/data-science/Data/data_out/carbon/carbon_splined_NSW_1970_2000_Data.csv")
...
output_dir <- "D:/InputData/Soil_with_raster"
