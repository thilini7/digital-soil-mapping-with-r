...
# Input data path
soil_data_csv <- file.path("Data/data_out/Soil_data_with_covariates_v2",
                           paste0(soil_property, "_with_covariates_new.csv"))

# Output data path
output_dir <- file.path("Data/data_out/RData_v2")
...
range_file <- file.path("Data/data_out/Soil_property_ranges", 
