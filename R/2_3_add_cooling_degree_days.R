...
soil_data <- read.csv("/Data/data_out/Soil_data_with_covariates/OC_with_covariates_new.csv")
cat("Loaded", nrow(soil_data), "soil points\n")

# 2. Load the Cooling Degree Days raster (from original covariates folder)
cdd_path <- "/Data/data_in/soil_covariates/Cooling_Degree_Days_Annual_90m.tif"
...
output_file <- "/Data/data_out/Soil_data_with_covariates/OC_with_covariates_new.csv"
